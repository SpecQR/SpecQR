...
| GS1 Digital Link helper | Partial / tested | `createGs1DigitalLink()` と `parseGs1DigitalLink()` は実装済みです。resolver、compression、full canonicalizer は [GS1 Digital Link v2 Design](./gs1-digital-link-v2.md) に deferred として残しています。 |
