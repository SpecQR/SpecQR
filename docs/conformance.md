...
| GS1 validation API | Tested | `getSupportedGs1Ais()`、`getGs1AiInfo(ai)`、`validateGs1Elements()`、`validateGs1ElementString()`、GS1 detail error code、packed package smoke、TypeScript surface を確認しています。Digital Link 専用の `validateGs1DigitalLink()` は未公開です。 |
