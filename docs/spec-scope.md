...
- GS1 Digital Link helper: `createGs1DigitalLink()` を起点に、次に `parseGs1DigitalLink()` と round-trip validation を追加する。URL-based Digital Link と FNC1 first の GS1 element string QR は API と docs で分ける。
