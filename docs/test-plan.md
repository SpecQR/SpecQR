...
- Normalization: string return、idempotency、GS1 AI query lexical sort、unknown query の non-sorting policy、SpecQR deterministic policy と full canonicalizer の違いを unit / packed package smoke / docs で確認すること。
